        ...
        <div class="hero min-h-screen bg-base-200">
            <div class="hero-content flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <p class="py-6 text-lg">I am currently a full time student doing my CSE degree from Brac University. I have a 4.0 cgpa and all of these projects and github contributions are extra work after my studies to boost my skills.</p>
                    <p class="py-6 text-lg">Tech I use: React for building the client side of an application. Express, node to build the server</p>
